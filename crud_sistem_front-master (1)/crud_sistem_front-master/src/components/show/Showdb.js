                              ...
                              </tr>
                                {
                                  equipos.map((equipoL) => (
                                    <tr style={{ height: '16.3pt' }}>
                                      <td style={{ width: '75.4pt', borderStyle: 'solid', borderWidth: '0.75pt', paddingRight: '5.03pt', paddingLeft: '5.03pt', verticalAlign: 'top' }}>
                                        <p style={{ marginTop: '0pt', marginBottom: '0pt', textAlign: 'center', fontSize: '11pt' }}><span style={{ fontFamily: 'Calibri' }}>{equipoL.equipo}</span></p>
                                      </td>
                                      <td style={{ width: '49.2pt', borderStyle: 'solid', borderWidth: '0.75pt', paddingRight: '5.03pt', paddingLeft: '5.03pt', verticalAlign: 'top' }}>
                                        <p style={{ marginTop: '0pt', marginBottom: '0pt', textAlign: 'center', fontSize: '11pt' }}><span style={{ fontFamily: 'Calibri' }}>{equipoL.marca}</span></p>
                                      </td>
                                      <td style={{ width: '152.25pt', borderStyle: 'solid', borderWidth: '0.75pt', paddingRight: '5.03pt', paddingLeft: '5.03pt', verticalAlign: 'top' }}>
                                        <p style={{ marginTop: '0pt', marginBottom: '0pt', textAlign: 'center', fontSize: '11pt' }}><span style={{ fontFamily: 'Calibri' }}> {equipoL.modelo} </span></p>
                                      </td>
                                      <td style={{ width: '85pt', borderStyle: 'solid', borderWidth: '0.75pt', paddingRight: '5.03pt', paddingLeft: '5.03pt', verticalAlign: 'top' }}>
                                        <p style={{ marginTop: '0pt', marginBottom: '0pt', textAlign: 'center', fontSize: '11pt' }}><span style={{ fontFamily: 'Calibri' }}>{equipoL.serial}</span></p>
                                      </td>
                                      <td style={{ width: '121.1pt', borderStyle: 'solid', borderWidth: '0.75pt', paddingRight: '5.03pt', paddingLeft: '5.03pt', verticalAlign: 'top' }}>
                                        <p style={{ marginTop: '0pt', marginBottom: '0pt', textAlign: 'center', fontSize: '11pt' }}><span style={{ fontFamily: 'Calibri' }}>{equipoL.placa}</span></p>
                                      </td>
                                    </tr>
                                  ))
                                }
